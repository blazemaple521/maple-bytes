...
public class RadioSubjectConvertImpl implements RadioSubjectConvert {
    ...
    @Override
    public List<SubjectInfoBO> convertToRadioBoList(List<SubjectInfo> subjectInfoList) {
    ...
    @Override
    public List<SubjectAnswerBO> convertRadioListToInfoBoList(List<SubjectRadio> result) {
        if ( result == null ) {
            return null;
        }
