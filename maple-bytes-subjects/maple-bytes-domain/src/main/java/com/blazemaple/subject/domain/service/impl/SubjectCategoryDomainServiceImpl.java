...
import com.blazemaple.subject.domain.convert.SubjectCategoryConvert;
...
public class SubjectCategoryDomainServiceImpl implements SubjectCategoryDomainService {
    ...
    public void add(SubjectCategoryBO subjectCategoryBO) {
        if (log.isInfoEnabled()) {
            log.info("add subject category, subjectCategoryBO: {}", JSON.toJSONString(subjectCategoryBO));
        }
    ...
    public List<SubjectCategoryBO> queryCategory(SubjectCategoryBO subjectCategoryBO) {
        ...
        List<SubjectCategoryBO> boList = SubjectCategoryConvert.INSTANCE.convertToCategoryBoList(
            subjectCategoryList);
        if (log.isInfoEnabled()) {
            log.info("query category, boList: {}", JSON.toJSONString(boList));
        }
        return boList;
    }
