...
import com.blazemaple.auth.application.convert.AuthRolePermissionDtoConvert;
...
public class RolePermissionController {
    ...
    public Result<Boolean> add(@RequestBody AuthRolePermissionDTO authRolePermissionDTO) {
        try {
            ...
            AuthRolePermissionBO rolePermissionBO = AuthRolePermissionDtoConvert.INSTANCE.convertDtoToBo(
