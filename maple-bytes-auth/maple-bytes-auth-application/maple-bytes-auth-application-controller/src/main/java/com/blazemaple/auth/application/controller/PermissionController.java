...
import com.blazemaple.auth.application.convert.AuthPermissionDtoConvert;
...
public class PermissionController {
    ...
    public Result<Boolean> add(@RequestBody AuthPermissionDTO authPermissionDTO) {
        try {
            ...
            AuthPermissionBO permissionBO = AuthPermissionDtoConvert.INSTANCE.convertDtoToBo(authPermissionDTO);
